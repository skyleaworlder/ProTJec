...
INSERT INTO `ProTJec`.`users` (`id`, `usr_no`, `usr_password`, `usr_name`, `usr_userlevel`, `usr_inst`, `usr_grade`, `usr_avatar`, `usr_document`, `usr_chat`) VALUES (4, '1753127', '123456', 'Aober', 1, '材料工程学院', 2017, DEFAULT, DEFAULT, 'wechat: Lion-Cold-Moon');
INSERT INTO `ProTJec`.`users` (`id`, `usr_no`, `usr_password`, `usr_name`, `usr_userlevel`, `usr_inst`, `usr_grade`, `usr_avatar`, `usr_document`, `usr_chat`) VALUES (5, '1950317', '123456', 'five', 1, '中德学院', 2019, DEFAULT, DEFAULT, 'qq:870033937');
...
INSERT INTO `ProTJec`.`projects` (`id`, `pro_name`, `pro_sort`, `pro_releaseTime`, `pro_endTime`, `pro_need`, `pro_intro`, `pro_state`, `pro_deleted`) VALUES (4, 'flask-cli', '理工', '2020-05-03 18:00:00', '2020-06-01 12:50:50', 2, '渴望对django和OA有理解的朋友加入', DEFAULT, DEFAULT);
INSERT INTO `ProTJec`.`projects` (`id`, `pro_name`, `pro_sort`, `pro_releaseTime`, `pro_endTime`, `pro_need`, `pro_intro`, `pro_state`, `pro_deleted`) VALUES (5, 'WhereYouGo(WYG)', '其他', '2020-05-03 19:01:00', '2020-07-31 12:59:59', 1, '希望有个同学和我一起去重庆旅游', DEFAULT, DEFAULT);
INSERT INTO `ProTJec`.`projects` (`id`, `pro_name`, `pro_sort`, `pro_releaseTime`, `pro_endTime`, `pro_need`, `pro_intro`, `pro_state`, `pro_deleted`) VALUES (6, '基于基于的基于型基于研究', '社科', '2020-05-03 19:21:00', '2020-05-04 13:21:01', 2, '基于基于基于基于，我们一起基于吧！', DEFAULT, DEFAULT);
INSERT INTO `ProTJec`.`projects` (`id`, `pro_name`, `pro_sort`, `pro_releaseTime`, `pro_endTime`, `pro_need`, `pro_intro`, `pro_state`, `pro_deleted`) VALUES (7, '神剑教学系统', '理工', '2020-05-04 00:00:00', '2020-12-31 23:59:59', 1, '急需一位熟练掌握 UI 设计、前端、后端开发、运维技术的同学来我们项目组做 PPT', DEFAULT, DEFAULT);
INSERT INTO `ProTJec`.`projects` (`id`, `pro_name`, `pro_sort`, `pro_releaseTime`, `pro_endTime`, `pro_need`, `pro_intro`, `pro_state`, `pro_deleted`) VALUES (8, '同心云重启计划（一期）', '设计', '2020-05-09 13:50:12', '2020-10-01 11:12:13', 2, '一期主要是设计', DEFAULT, DEFAULT);
INSERT INTO `ProTJec`.`projects` (`id`, `pro_name`, `pro_sort`, `pro_releaseTime`, `pro_endTime`, `pro_need`, `pro_intro`, `pro_state`, `pro_deleted`) VALUES (9, '啦啦啦', '文史', '2020-05-09 13:50:13', '2020-07-01 11:11:11', 3, '啦啦啦', DEFAULT, DEFAULT);
INSERT INTO `ProTJec`.`projects` (`id`, `pro_name`, `pro_sort`, `pro_releaseTime`, `pro_endTime`, `pro_need`, `pro_intro`, `pro_state`, `pro_deleted`) VALUES (10, 'Euliration', '经管', '2020-05-12 00:00:00', '2021-05-12 00:00:00', 1, '占位', DEFAULT, DEFAULT);
INSERT INTO `ProTJec`.`projects` (`id`, `pro_name`, `pro_sort`, `pro_releaseTime`, `pro_endTime`, `pro_need`, `pro_intro`, `pro_state`, `pro_deleted`) VALUES (11, 'Fpk', '经管', '2020-05-24 13:12:07', '2020-09-01 14:47:29', 2, 'Fpk', DEFAULT, DEFAULT);
...
INSERT INTO `ProTJec`.`usr_pro` (`upr_role`, `usr_id`, `pro_id`) VALUES ('C', 4, 4);
INSERT INTO `ProTJec`.`usr_pro` (`upr_role`, `usr_id`, `pro_id`) VALUES ('C', 5, 5);
INSERT INTO `ProTJec`.`usr_pro` (`upr_role`, `usr_id`, `pro_id`) VALUES ('C', 1, 6);
INSERT INTO `ProTJec`.`usr_pro` (`upr_role`, `usr_id`, `pro_id`) VALUES ('C', 1, 7);
INSERT INTO `ProTJec`.`usr_pro` (`upr_role`, `usr_id`, `pro_id`) VALUES ('C', 1, 8);
INSERT INTO `ProTJec`.`usr_pro` (`upr_role`, `usr_id`, `pro_id`) VALUES ('C', 2, 9);
INSERT INTO `ProTJec`.`usr_pro` (`upr_role`, `usr_id`, `pro_id`) VALUES ('C', 4, 10);
INSERT INTO `ProTJec`.`usr_pro` (`upr_role`, `usr_id`, `pro_id`) VALUES ('C', 5, 11);
INSERT INTO `ProTJec`.`usr_pro` (`upr_role`, `usr_id`, `pro_id`) VALUES ('F', 3, 10);
INSERT INTO `ProTJec`.`usr_pro` (`upr_role`, `usr_id`, `pro_id`) VALUES ('F', 3, 8);
...
START TRANSACTION;
USE `ProTJec`;
INSERT INTO `ProTJec`.`tags` (`id`, `tag_name`, `tag_cnt`) VALUES (1, '大创', 2);
INSERT INTO `ProTJec`.`tags` (`id`, `tag_name`, `tag_cnt`) VALUES (2, '挑战杯', 1);
INSERT INTO `ProTJec`.`tags` (`id`, `tag_name`, `tag_cnt`) VALUES (3, '建模', 0);
INSERT INTO `ProTJec`.`tags` (`id`, `tag_name`, `tag_cnt`) VALUES (4, '环科', 0);
INSERT INTO `ProTJec`.`tags` (`id`, `tag_name`, `tag_cnt`) VALUES (5, '华为', 0);
INSERT INTO `ProTJec`.`tags` (`id`, `tag_name`, `tag_cnt`) VALUES (6, '贝恩', 0);
INSERT INTO `ProTJec`.`tags` (`id`, `tag_name`, `tag_cnt`) VALUES (7, 'ACM', 0);
...
-- -----------------------------------------------------
-- Data for table `ProTJec`.`response`
-- -----------------------------------------------------
START TRANSACTION;
USE `ProTJec`;
INSERT INTO `ProTJec`.`response` (`id`, `rsp_time`, `rsp_state`, `usr_id`, `pro_id`) VALUES (1, '2020-05-24 12:12:12', 'W', 1, 5);
INSERT INTO `ProTJec`.`response` (`id`, `rsp_time`, `rsp_state`, `usr_id`, `pro_id`) VALUES (2, '2020-05-24 12:13:13', 'W', 2, 5);
INSERT INTO `ProTJec`.`response` (`id`, `rsp_time`, `rsp_state`, `usr_id`, `pro_id`) VALUES (3, '2020-05-25 12:13:12', 'W', 3, 4);
